...
df_file = "../../data/final/03_data_feature.pkl"
df = pd.read_pickle(df_file)

# Create a training and test set

df_model = df.drop(["participant", "category", "set"], axis=1)
...
df_model["label"].value_counts().plot(
...
time_features = [f for f in df_model.columns if "_temp" in f]
freq_features = [f for f in df_model.columns if ("_freq" in f) or ("_pse" in f)]
